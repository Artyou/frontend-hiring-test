  ...
  $scope.sendMessage = function (search) {
	...
	var results = [];
  	...
  	if (search.actor !== undefined) {
  		var API_URL = "http://netflixroulette.net/api/api.php?" + actor;
  	} else if (search.director !== undefined) {
  		var API_URL = "http://netflixroulette.net/api/api.php?" + director;
  	} else if(search.director !== undefined && search.actor !== undefined){
  		var API_URL = "http://netflixroulette.net/api/api.php?" + director + "&" + actor;
  	}
